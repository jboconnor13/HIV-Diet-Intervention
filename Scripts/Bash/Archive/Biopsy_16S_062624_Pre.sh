...
qiime taxa filter-table \
  ...
  --o-filtered-table Biopsy/twice-filtered-feature-table.qza

qiime feature-table summarize \
  --i-table Biopsy/twice-filtered-feature-table.qza \
  --o-visualization Biopsy/twice-filtered-feature-table.qzv \
  --m-sample-metadata-file Biopsy/Metadata/allmetadata.txt