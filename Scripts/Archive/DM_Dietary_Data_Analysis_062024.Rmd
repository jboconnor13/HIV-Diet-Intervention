...
nutt1t2plot <- ggplot(t1t2_nut_data, aes(x=Diet, y=as.numeric(t1t2_nut_data$`T1-T2`))) +
  ...
  labs(y="", title="Euclidean Distance T1-T2", x="", tag="A")+
  theme_bw()+
...
nutt1t3plot <- ggplot(t1t3_nut_data, aes(x=Diet, y=as.numeric(t1t3_nut_data$`T1-T3`))) +
  ...
  geom_jitter()+
  scale_fill_manual(values=c("darkgreen","darkorange")) +
  labs(y="", title="Euclidean Distance T1-T3", x="", tag="B")+
  theme_bw()+
  theme(title=element_text(size=15),
        axis.text.y=element_text(size=15),
        axis.text.x=element_text(size=15),
...
#Supplemental Figure 1 is the deltas 
supp_fig_1 <- ggarrange(nutt1t2plot, nutt1t3plot, nrow=1)
